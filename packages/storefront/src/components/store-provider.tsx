...
// Synchronous tRPC client — created once at module level
...
export function StoreProvider({ store, children }: StoreProviderProps) {
  ...
  const config = (store.storeConfig || (store as any).config) as unknown as StoreConfig;
  ...
  const value = useMemo<StoreContextValue>(() => ({
    ...
    setCartCount,
    trpc: trpcClient,
  }), [store, design, config, cartId, cartCount]);
